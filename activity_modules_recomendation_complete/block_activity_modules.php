...
$this->content->items[] = '<b>Recomendar Vídeo-aulas</b>';
...
//    echo '<br />The ' . $_POST['submit'].'<br />';
                ...
                /*$this->content->items[] = '<a href="'.$CFG->wwwroot.'/blocks/activity_modules/index.php?id='.$course->id.'&section='.$escolha.'">Recomendar Vídeo-aulas</a>';*/


               /* //ver como colocar para pegar a seção ??????
                if ($ADMIN->fulltree) {
                      $settings->add(new admin_setting_configselect('block_activity_modules/list_course', get_string('list_course', 'block_activity_modules'), get_string('select_course', 'block_activity_modules'),'0',$listcourse));
