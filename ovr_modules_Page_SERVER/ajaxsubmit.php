...
//-- instance = id da url adicionada na tabela mdl_url
		...
		$flag = true;
		$sql ="INSERT INTO mdl_page (course,name,intro,introformat,content,contentformat,legacyfiles, legacyfileslast,display,displayoptions,revision,timemodified) VALUES(".$_POST['cid'].",\"".$names[$i]."\",\"<html lang=\"\"pt-br\"\">
<head>
    <meta charset=\"\"utf-8\"\">
...
<body><a href=\"\"javascript:void(0)\"\" onclick=\"\"Avaliar(1)\"\"><img src=\"\"img/star0.png\"\" id=\"\"s1\"\"></a><a href=\"\"javascript:void(0)\"\" onclick=\"\"Avaliar(2)\"\"><img src=\"\"img/star0.png\"\" id=\"\"s2\"\"></a><a href=\"\"javascript:void(0)\"\" onclick=\"\"Avaliar(3)\"\"><img src=\"\"img/star0.png\"\" id=\"\"s3\"\"></a><a href=\"\"javascript:void(0)\"\" onclick=\"\"Avaliar(4)\"\"><img src=\"\"img/star0.png\"\" id=\"\"s4\"\"></a><a href=\"\"javascript:void(0)\"\" onclick=\"\"Avaliar(5)\"\"><img src=\"\"img/star0.png\"\" id=\"\"s5\"\"></a><p id=\"\"rating\"\">0</p></body>
</html>\", 1,\"<p>&nbsp;&nbsp;<video controls=\"\"true\"\"><source src=\"\"".$urls[$i]."\"\">".$urls[$i]."</video>&nbsp;&nbsp;<br></p>\", 1, 0, NULL, 5, \"a:2:{s:12:\"\"printheading\"\";s:1:\"\"1\"\";s:10:\"\"printintro\"\";s:1:\"\"0\"\";}\", 1,unix_timestamp(now()))";
		$id_mdl_url=-1;
